...
const TermsAndConditions = () => {
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <p className="mb-4 text-gray-700">Welcome to Dr. Prashant Padole !</p>

      <p className="mb-4 text-gray-700">
        These terms and conditions outline the rules and regulations for the use
        of GBJBuzz&apos;s Website, located at
        https://rg-web-replica.vercel.app/.
      </p>

      <p className="mb-4 text-gray-700">
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Dr. Prashant Padole if you do not
      ...
      <p className="mb-4 text-gray-700">
        We employ the use of cookies. By accessing Dr. Prashant Padole , you
        agreed to use cookies in agreement with the GBJBuzz&apos;s Privacy
        Policy.{" "}
      </p>
      ...
      <p className="mb-4 text-gray-700">
        Unless otherwise stated, GBJBuzz and/or its licensors own the
        intellectual property rights for all material on Dr. Prashant Padole .
        All intellectual property rights are reserved. You may access this from
        Dr. Prashant Padole for your own personal use subjected to restrictions
        set in these terms and conditions.
      </p>

      <p className="mb-4 text-gray-700">You must not:</p>
      <ul className="list-disc pl-8 mb-4 text-gray-700">
        <li>Republish material from Dr. Prashant Padole </li>
        <li>Sell, rent or sub-license material from Dr. Prashant Padole </li>
        <li>Reproduce, duplicate or copy material from Dr. Prashant Padole </li>
        <li>Redistribute content from Dr. Prashant Padole </li>
      </ul>
      ...
      <p className="mb-4 text-gray-700">
        ...
        GBJBuzz does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of GBJBuzz,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, GBJBuzz shall not be liable for the
      ...
      <p className="mb-4 text-gray-700">
        GBJBuzz reserves the right to monitor all Comments and to remove any
      ...
      <p className="mb-4 text-gray-700">
        You hereby grant GBJBuzz a non-exclusive license to use, reproduce, edit
      ...
      <p className="mb-4 text-gray-700">
        ...
        the hyperlink compensates the absence of GBJBuzz; and (d) the link is in
      ...
      <p className="mb-4 text-gray-700">
        ...
        e-mail to GBJBuzz. Please include your name, your organization name,
      ...
      <p className="mb-4 text-gray-700">
        No use of GBJBuzz&apos;s logo or other artwork will be allowed for
